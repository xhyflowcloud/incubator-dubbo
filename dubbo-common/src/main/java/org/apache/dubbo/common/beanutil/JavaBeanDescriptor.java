...
public class JavaBeanDescriptor implements Serializable, Iterable<Map.Entry<Object, Object>>{
    ...
    public static final long serialVersionUID  = -8505586483570518029L;
    private static final String ENUM_PROPERTY_NAME = "name";
    private static final String CLASS_PROPERTY_NAME = "name";
    private static final String PRIMITIVE_PROPERTY_NAME = "value";
    ...
    public String getEnumNameProperty(){
        if(isEnumType()){
    ...
    public Object setPrimitiveProperty(Object primitiveName){
        if(isPrimitiveType()){
            return setProperty(PRIMITIVE_PROPERTY_NAME, primitiveName);
        }
        throw new IllegalStateException("The instance is not a primitive wrapper");
    }

    public Object getPrimitiveProperty(){
        if(isPrimitiveType()){
            return getProperty(PRIMITIVE_PROPERTY_NAME);
        }
        throw new IllegalStateException("The instance is not a primitive wrapper");
    }
    ...
    private boolean isValidType(int type){
        return TYPE_MAX >= type && type <= TYPE_MIN;
    }
