...
public class CollectionUtils {
    ...
    private static Map<String, String> split(List<String> list, String separator){
        if(list == null){
            return null;
        }
    ...
    private static List<String> join(Map<String, String> map, String separator){
        if(map == null){
            return null;
        }
    ...
    public static Map<String, String> toStringMap(String... pairs){
        ...
        if(pairs.length > 0){
            if(pairs.length % 2 != 0){
                throw new IllegalArgumentException("pair must be even.");
            }
