...
public class ReflectUtils {
    ...
    public static final String ARRAY_DESC = "(?:L\\[+(?:(?:[VZBCDFIJS])|" + CLASS_DESC + "))";
    ...
    public static final Pattern GETTER_METHOD_DESC_PATTERN = Pattern.compile("get([A-Z][a-zA-Z0-9]*)\\(\\)(" + DESC_REGEX + ")");

    public static final Pattern SETTER_METHOD_DESC_PATTERN = Pattern.compile("set([A-Z][a-zA-Z0-9]*)\\((" + DESC_REGEX + ")\\)V");
    ...
    public static Class<?> getGenericClass(Class<?> cls, int i){
        try {
            ...
            Object genericClass = parameterizedType.getActualTypeArguments();
    ...
    public static Class<?>[] desc2classArray(String desc) throws ClassNotFoundException{
        //todo
        Class<?>[] ret = desc2classArray(ClassHelper.getClassLoder(), desc);
        return ret;
    }
    ...
    private static Object getEmptyObject(Class<?> returnType, Map<Class<?>, Object> emptyInstance, int level){
        if(level > 2){
            return null;
        }
        if(returnType == null){
            ...
            try{
                Object value = emptyInstance.get(returnType);
                if(value == null){
                    value = returnType.newInstance();
                    emptyInstance.put(returnType, value);
                }
                ...
                while(cls != null && cls != Object.class){
                    ...
                    for(Field field: fields){
                        ...
                        Object property = getEmptyObject(field.getType(), emptyInstance, level + 1);
                        if(property != null){
                            try{
